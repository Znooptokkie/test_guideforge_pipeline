...
--    user_edited_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
-- );
...
-- ADD CONSTRAINT fk_revision_user FOREIGN KEY (revision_user_id) REFERENCES user(user_id) ON DELETE SET NULL;


-- ALTER TABLE revision
-- ADD CONSTRAINT fk_revision_revision FOREIGN KEY (revision_previous_revision_id) REFERENCES revision(revision_id) ON DELETE SET NULL;
...
--    PRIMARY KEY (article_id, safety_equipment_id),
--    FOREIGN KEY (article_id) REFERENCES article(article_id) ON DELETE CASCADE,
--    FOREIGN KEY (safety_equipment_id) REFERENCES safety_equipment(safety_equipment_id) ON DELETE CASCADE
-- );
